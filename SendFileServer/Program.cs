    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                string filePath = @"C:\Users\lab605b\Desktop\\";//Your File Path;
                byte[] fileNameByte = Encoding.ASCII.GetBytes(fileName);  //not content just the name test.txt

                byte[] fileData = File.ReadAllBytes(filePath + fileName); // Read content of :\FT\test.txt
